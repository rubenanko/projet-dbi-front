function Boxworld() {
    return (
      <div className="flex border rounded-lg shadow-lg p-5 bg-pink-200">
        {/* Image à gauche */}
        <div className="w-2/5">
        ...
        <div className="w-2/3 pl-4 flex flex-col justify-between">
          <div>
            <h1 className="text-2xl text-violet-500 font-bold mb-2">World</h1>
            <p className="text-violet-500 font-bold mb-4">Voir le classement mondial et votre position dans la league</p>
          </div>
          <div>

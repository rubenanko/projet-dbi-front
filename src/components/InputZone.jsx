...
function InputZone()
{
    return(
        <div class="place-self-center relative justify-center mt-10 w-3/5 text-gray-900 border border-gray-300 rounded-md bg-cyan-50 focus-within:shadow-lg focus-within:ring-blue-500 transition focus-within:scale-105">
            ...
            <button type="button" class="absolute right-5 bottom-2 text-white bg-cyan-500 hover:bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-yellow-500 font-medium rounded-md text-sm px-4 py-2 my-5">Répondre</button>
        </div>
    );
}

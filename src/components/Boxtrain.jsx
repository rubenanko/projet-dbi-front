function Boxtrain() {
    return (
      <div className="flex border rounded-lg shadow-lg p-5 bg-yellow-200 hover:scale-105 transition duration-300">
        {/* Image à gauche */}
        <div className="w-2/5">
        ...
        <div className="w-2/3 pl-4 flex flex-col justify-between">
          <div>
            <h1 className="text-2xl text-orange-500 font-bold mb-2 font-coiny">S'entrainer</h1>
            <p className="text-orange-500 font-bold mb-4 font-coiny">Génère des questions, des quiz ou bien étudie tes erreurs précédentes</p>
          </div>
          <div>
